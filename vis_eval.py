...
args.exp_name = f"{args.task}_win{args.window_size}_epoch{args.epochs}_lr{args.lr}_wd{args.weight_decay}_bs{args.batch_size}_alpha{args.alpha}_cv{args.cross_val_type}_nr{args.normalize_roi}_{args.architecture}_{args.exp_id}"

figure_root_path = os.path.join('figures', args.exp_name)
